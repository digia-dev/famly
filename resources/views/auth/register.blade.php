<x-guest-layout>
    <main class="w-full max-w-md bg-white min-h-[600px] flex flex-col mx-auto px-6 py-8 relative overflow-hidden">
        ...
        <!-- Navigation -->
        <div class="mb-10">
            <a href="{{ route('login') }}" class="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center hover:bg-slate-100 transition-all">
        ...
        <header class="mb-12">
            ...
            <h1 class="text-4xl font-extrabold text-slate-900 tracking-tight leading-none">Daftar Akun</h1>
            <p class="text-slate-500 text-sm font-medium mt-3">Bergabunglah dengan ekosistem keluarga digital masa depan.</p>
        </header>
        ...
        <form method="POST" action="{{ route('register') }}" class="flex-1 flex flex-col">
            ...
            <div class="space-y-5">
                ...
                <!-- Input Module: Konfirmasi Kata Sandi -->
                <div class="space-y-2">
                    <label class="text-[11px] font-bold text-slate-500 uppercase tracking-widest ml-1">Konfirmasi Sandi</label>
                    <div class="relative flex items-center">
                        <span class="material-symbols-outlined absolute left-4 text-slate-400 text-[20px]">shield_lock</span>
            ...
            <div class="mt-auto pt-10 pb-6 space-y-6">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <span class="text-[10px] font-black text-slate-300 uppercase tracking-widest">Atau Daftar Dengan</span>
                    <div class="h-[1px] bg-slate-100 flex-1"></div>
                </div>
                ...
                <footer class="text-center pt-4">
                    <a href="{{ route('login') }}" class="text-sm font-bold text-slate-500 hover:text-[#00AA13] transition-all">
                        Sudah punya akun? <span class="text-[#00AA13]">Masuk di sini</span>
                    </a>
                </footer>
            </div>
        </form>
