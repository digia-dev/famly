...
<style>
.theme-switch {
    --toggle-size: 20px; /* Smaller size for navbar */
    --container-width: 3.5em;
    --container-height: 1.8em;
    --container-radius: 6.25em;
    --container-light-bg: linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%);
    --container-night-bg: linear-gradient(135deg, #1f2937 0%, #374151 100%);
    --circle-container-diameter: 2.2em;
    --sun-moon-diameter: 1.4em;
    --sun-bg: linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%);
    --moon-bg: linear-gradient(135deg, #e5e7eb 0%, #9ca3af 100%);
    --spot-color: #6366f1;
    --circle-container-offset: calc((var(--circle-container-diameter) - var(--container-height)) / 2 * -1);
    --stars-color: #fbbf24;
    --clouds-color: #ffffff;
    --back-clouds-color: #3b82f6;
...
.theme-switch__circle-container {
    ...
    border-radius: var(--container-radius);
    box-shadow: 
        inset 0 0 0 2.2em rgba(255, 255, 255, 0.08),
...
.theme-switch__sun-moon-container {
    ...
    box-shadow: 
        0.05em 0.05em 0.05em 0 rgba(255, 255, 255, 0.4) inset,
        0 -0.05em 0.05em 0 rgba(0, 0, 0, 0.2) inset,
        0 0.1em 0.2em rgba(0, 0, 0, 0.15);
    overflow: hidden;
    transition: var(--transition);
...
.theme-switch__spot {
    ...
    box-shadow: 0 0.02em 0.05em rgba(0, 0, 0, 0.2) inset;
}
...
.theme-switch__clouds {
    ...
    left: 0.2em;
    box-shadow: 
        0.6em 0.2em var(--clouds-color),
        -0.2em -0.2em var(--back-clouds-color),
        1em 0.25em var(--clouds-color),
        0.3em -0.1em var(--back-clouds-color),
        1.4em 0 var(--clouds-color),
        0.8em -0.05em var(--back-clouds-color),
        1.8em 0.2em var(--clouds-color),
        1.2em -0.2em var(--back-clouds-color);
    transition: var(--transition);
}
...
document.addEventListener('DOMContentLoaded', function() {
    // Initialize theme toggle if it doesn't exist
